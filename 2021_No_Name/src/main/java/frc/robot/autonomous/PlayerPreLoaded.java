...
public class PlayerPreLoaded extends CommandBase {
  ...
  public PlayerPreLoaded(ArrayList<double[]> autoArrayList) {
  ...
  public void initialize() {
    ...
    System.out.println("playing auto preLoaded");
    } else {
      isFinished = true;
      isPlaying = false;
      SmartDashboard.putBoolean("isPlaying", isPlaying);
